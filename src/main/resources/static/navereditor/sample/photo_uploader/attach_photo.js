    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/report/editor-image-upload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl  : '/WebEditorDemo2/galleryimageupload.action',
 			sCallback : '/WebEditorDemo2/navereditor/sample/photo_uploader/callback.html',
